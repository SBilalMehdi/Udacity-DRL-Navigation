...
class Agent():
    ...
    def step(self, state, action, reward, next_state, done):
        ...
        ======
            ...
            done: boolean indicating the end of the episode
        """
    ...
    def act(self, state, eps=0.):
        """Given the state, use epsilon greedy policy to return an action.
        
        Params
        ======
            state: current state
            eps: epsilon as used for the epsilon greedy policy
        """
    ...
    def soft_update(self, local_model, target_model):
        ...
        ======
            ...
            tau: learning-rate-like parameter. 0 implies no change  in target parameters. 1 implies copy local network to target network.
        """
